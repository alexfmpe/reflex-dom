...
{-# INLINABLE fullAPIDomEventHandler #-}
fullAPIDomEventHandler :: IsElement e => e -> EventName en -> EventM e (EventType en) (Maybe (EventProps en))
fullAPIDomEventHandler e evt = fmap (Just . EventProps) $ case evt of
